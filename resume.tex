...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% Essentials
\name{Pradeep}{Thalasta}
\address{2652 Ellendale Place, Apartment 1,\\Los Angeles, California, 90007.}
\mobile{+1(323) 690-6523} 
%%% Social
\email{thalasta@usc.edu}
%\homepage{www.posquit0.com}
\github{https://github.com/prodo56}
\linkedin{https://www.linkedin.com/in/pradeepthalasta5693}
%%% Optionals
